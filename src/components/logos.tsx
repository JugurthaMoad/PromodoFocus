...
export const Login = (props: LogoProps) => {
  return (
    <div>
      <svg
        {...props}
...
export const Setting = (props: LogoProps) => {
  return (
    <div>
      <svg
        {...props}
      ...
      >
        ...
        <path fill="white" d="M0 0h48v48H0z" mask="url(#svgIDa)" />
      </svg>
    </div>
  );
};

export const Report = (props: LogoProps) => {
  return (
    <div>
      <svg
        {...props}
      ...
      >
        <g fill="none" stroke="white" strokeWidth="1.5">
          <path
            ...
            d="M10 9H6m9.5 2a2.5 2.5 0 1 1 0-5a2.5 2.5 0 0 1 0 5ZM6 6h3m9 12l-4.5-3l-2.5 2l-5-4"
          />
...
export const Stop = (props: LogoProps) => {
  return (
    <div>
      <svg
        xmlns="http://www.w3.org/2000/svg"
